...
void Node_PDOConfig(Epos* epos)
{
	...
	SDO_Write(epos,0x18010120,0x01,(0x280+epos->node_ID)|RTR_NOAllow); 
	...
	SDO_Write(epos,0x1A000120,0x01,Position_actual_value); 
//	SDO_Write(epos,0x1A000220,0x01,Velocity_actual_value);
	SDO_Write(epos,0x1A000220,0x01,Velocity_actual_value_averaged);
	SDO_Write(epos,0x1A000008,0x01,2); 
	
	SDO_Write(epos,0x1A010008,0x01,0); 
	SDO_Write(epos,0x1A010120,0x01,Current_actual_value); 
	SDO_Write(epos,0x1A010220,0x01,Torque_actual_value);
