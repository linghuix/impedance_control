...
void Node_PDOConfig(Epos* epos)
{
    ...
    SDO_Write(epos,0x14010120,0x01,(0x300+epos->node_ID)|(0x80000000)); 	//unvaild
	SDO_Write(epos,0x14010208,0x01,0x1); 								//ID与接收的TxPDO对应，实现两者之间的传输
    SDO_Write(epos,0x14020120,0x01,(0x400+epos->node_ID)|(0x80000000));
	SDO_Write(epos,0x14020208,0x01,0x1); 
    SDO_Write(epos,0x14030120,0x01,(0x500+epos->node_ID)|(0x80000000));
	...
	SDO_Write(epos,0x18000120,0x01,(0x280+epos->node_ID)|(0x80000000)); 
	SDO_Write(epos,0x18000220,0x01,0x1); 
	SDO_Write(epos,0x18000310,0x01,10);
	SDO_Write(epos,0x18000120,0x01,(0x380+epos->node_ID)|(0x80000000)); 
	SDO_Write(epos,0x18000220,0x01,0x1); 
	SDO_Write(epos,0x18000310,0x01,10);
	SDO_Write(epos,0x18000120,0x01,(0x480+epos->node_ID)|(0x80000000)); 
	SDO_Write(epos,0x18000220,0x01,0x1); 
	SDO_Write(epos,0x18000310,0x01,10);
